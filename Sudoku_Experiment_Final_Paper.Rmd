...
```{r models-outcome-cace, echo=FALSE, tab.cap="ITT and CACE Estimates for Puzzle Completion and Solve Time. Time analysis conditional on solvers only (N=28). No estimates are statistically significant.", results='asis', fig.pos='H'}
...
To complement the parametric analysis, we conducted a randomization inference analysis of the observed data. The group assignments were randomized 1,000 times to create a null distribution of simulated treatment effects. The observed values were compared to calculate two-sided p-values. Figure \@ref(fig:randomization-inference-chart) shows full distributions. None of the 4 outcomes were statistically significant (Completion-Video p-value `r round(completion_video_p,3)`, Completion-AI p-value `r completion_ai_p`, Time-Video p-value `r time_video_p`, Time-AI p-value `r time_ai_p`).
...
# Appendix
```{r itt-regression-table, results='asis', tab.cap="Regression Results ITT"}
