...
```{r models-outcome-cace, echo=FALSE, fig.cap="CACE results", results='asis'}
cat("CACE Video Completion:", round(cace_video_completion, 3), "\n")
cat("CACE AI Completion:", round(cace_ai_completion, 3), "\n")
cat("CACE Video Time:", round(cace_video_time, 2), "\n")
cat("CACE AI Time:", round(cace_ai_time, 2), "\n")
cat("Compliance Video:", round(compliance_rate_video, 1), "%\n")
cat("Compliance AI:", round(compliance_rate_ai, 1), "%\n")
