...
The AI tutor treatment used an embedded chat window using a ChatGPT chat bot with a specific prompt (full prompt in the Appendix). The participants were allowed to ask the chatbot questions about the rules of the game as they interacted with the first puzzle. The chat bot was instructed to be a tutor and not give away any information but rather they to guide the participant to discovering rules and strategies. 
